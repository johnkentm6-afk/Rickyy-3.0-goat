...
# Delay before starting (so you can click your chatbox)
print("You have 5 seconds to click on your chatbox...")
time.sleep(5)

# Auto-send messages
for i in range(5):  # Change 5 to how many loops you want
    for msg in messages:
        pyautogui.typewrite(msg)   # Types the message
        pyautogui.press("enter")   # Presses enter to send
        time.sleep(1)  # 1 second delay between messages 30s

translate this code into this code structure 
